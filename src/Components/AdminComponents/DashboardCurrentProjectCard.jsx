...
const DashboardCurrentProjectCard = ({name,type,date,period,images,status}) => {
    ...
    <Box
      ...
      >
        ...
        >
          ...
          <Typography textAlign="center" fontWeight="bold">{type}</Typography>
        </Box>
        <Box
          height={70}
          display="flex"
        ...
        >
          ...
          <Typography textAlign="center" fontWeight="bold">{date}</Typography>
        </Box>
        <Box
          height={70}
          display="flex"
        ...
        >
          ...
          <Typography textAlign="center" fontWeight="bold">{`${period} Days`}</Typography>
        </Box>
        <Box
          height={70}
          display="flex"
        ...
        >
          ...
          <Typography textAlign="center" fontWeight="bold">{status}</Typography>
        </Box>
      </Box>
  )
}
